...
func main() {
	...
	if n < 11 {
		...
		for i := 1010; i < 10000; i += 101 {
			if n < i {
				goto Outp
			}
			cnt++
		}
		for i := 100100; i < 1000000; i += 1001 {
			if n < i {
				goto Outp
			}
			cnt++
		}
		for i := 10001000; i < 100000000; i += 10001 {
			if n < i {
				goto Outp
			}
			cnt++
		}
		for i := 1000010000; i < 10000000000; i += 100001 {
			if n < i {
				goto Outp
			}
			cnt++
		}
		for i := 100000100000; i < 1000000000000; i += 1000001 {
			if n < i {
				goto Outp
			}
			cnt++
